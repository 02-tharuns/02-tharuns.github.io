...
function computeHealth(traces: Trace[]): ChatHealth {
  ...
  if (!total) return { total: 0, answered: 0, deflected: 0, refused: 0, avgMs: 0, p95Ms: 0, errorRate: 0 };
  ...
  return { total, answered, deflected, refused, avgMs, p95Ms, errorRate: errors / total };
}
