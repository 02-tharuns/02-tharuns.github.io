...
def test_chunk_markdown_matches_committed_corpus_size():
    ...
    moved twice the same day: 988->920 with the domain-fit simplification
    above (briefly 919 with a "Domains worked in" heading, before that was
    renamed to "Exposure" per feedback), then 920->923 when
    ...
    domain-fit docs) — a mismatch means textproc.py has drifted from
